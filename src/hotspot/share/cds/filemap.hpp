...
private:
  ...
  bool   _is_merged_cache;             // Was this archive produced by merging multiple AOT caches?
...
public:
  ...
  bool is_merged_cache()                   const { return _is_merged_cache; }
  void set_is_merged_cache(bool v)               { _is_merged_cache = v; }
